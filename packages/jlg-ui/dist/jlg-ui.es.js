                      ...
                      (I(!0), R(vt, null, Ve(y[l(a).children], (p) => {
                        ...
                        return I(), R("div", {
                          ...
                          class: V([
                            ...
                            ((m = n.defaultActive) == null ? void 0 : m[2]) === p[l(a).key] ? "jlg-menu-second-level-menu-selected" : "jlg-menu-second-level-menu-no-selected"
                          ]),
...
const Lt = (e, t) => {
  ...
  for (const [r, o] of t)
    n[r] = o;
  return n;
}, ht = /* @__PURE__ */ Lt(Ju, [["__scopeId", "data-v-0e6eaed6"]]);
ht.install = (e) => {
